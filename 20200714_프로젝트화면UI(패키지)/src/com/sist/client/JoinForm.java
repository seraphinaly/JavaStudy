...
public class JoinForm extends JPanel{
	...
	public JoinForm(){
		...
		title.setFont(new Font("함초롬돋움", Font.BOLD, 35));//HTML:<h1><b>회원가입</b></h1>
		...
		add(la10);add(js); //Panel에 올릴때
		
		box1=new JCheckBox("소고기");
		box2=new JCheckBox("돼지고기");
		box3=new JCheckBox("닭고기");
		box4=new JCheckBox("떡퓨");
		box5=new JCheckBox("회");
